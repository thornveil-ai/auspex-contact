...
[![Source](https://img.shields.io/badge/source-private%20(ECCN%204D004)-red)](#access)
[![Status](https://img.shields.io/badge/posture-federal--gated-darkred)](#access)
...
The artifacts in this repository (this README, contact card) are licensed under [Apache-2.0](LICENSE). The Auspex implementation source lives in a separate proprietary, export-controlled repository under EAR ECCN 4D004 classification.
